...
class HomeContent extends StatelessWidget {
  ...
  Widget _buildTempleCarousel(BuildContext context) {
    return Expanded(
            ...
            onTap: () {
              Navigator.push(
                ...
                PageRouteBuilder(
                  pageBuilder: (context, animation, secondaryAnimation) =>
                      TempleDetailScreen(
                        templeName: temples[index]['name']!,
                        imageUrl: temples[index]['image']!,
                        description: temples[index]['description']!,
                        rating: 4.7,
                      ),
                  transitionsBuilder:
